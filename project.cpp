...
inline int Youtube ::subcriber()
{
    ...
    if(subcribers>=100000)
    {
        return subcribers * 1 / 100;
        
    }
    else{
        return subcribers * 2 / 100;
    }
}
...
int main()
{
    ...
    cin>>name;
    cout<<"\nhi\t"<<name;
    cout<<"\twelcome to youtube chenal\n\n";
    ...
    cout << "\n--------------------------------- Total Earning --------------------------------------------------------------- \n";
    cout << "time\t\t   View\t\t  like\t\t  dislike\t\t  comment\t\t  shar";
    cout << "\n-----------------------------------------------------------------------------------------------------------------\n";
    cout << minutes<<"\t\t"<<views<<"\t\t"<<likes<<"\t\t"<<dislikes<<"\t\t"<<comments<<"\t\t"<<shares<<endl;

    cout<<"\nsuscriber ="<<subcribers;


    total = minutes + views+likes-dislikes+comments+shares+subcribers;
